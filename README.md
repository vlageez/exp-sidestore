# SideStore (exp-sidestore copy)

> **About this repo:** this is a copy of the upstream [SideStore](https://github.com/SideStore/SideStore)
> source at version 0.6.4-dev, which includes bug fixes newer than the v0.6.3
> release. If SideStore is showing errors on your iPad, start with
> [TROUBLESHOOTING-IPAD.md](TROUBLESHOOTING-IPAD.md) — most iPad errors are
> pairing/VPN setup issues, not app bugs. SideStore is licensed AGPL-3.0; see
> [LICENSE](LICENSE).
